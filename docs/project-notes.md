# Mini Lending Platform Documentation

This file is the documentation index for the project.
...
- `00-project-overview.md` keeps the product idea, scope, domain draft, and open questions.
